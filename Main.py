...
while True:
    ...
    for i in men:
        ...
        for j in men:
            ...
            if i.pos[0] - j.pos[0] > -i.range and i.pos[0] - j.pos[0] < i.range and i.pos[1] - j.pos[1] > -i.range and i.pos[1] - j.pos[1] < i.range and i.side != j.side and target_picked == False:
                if i.unittype == 'fs':
                    j.hp-=10
                    if j.hp > 0:
        ...
        ls = [men[0].side]
        for n in men:
            if n.side not in ls and n.side != 'm':
                towertarget = False
            ls.append(n.side)
